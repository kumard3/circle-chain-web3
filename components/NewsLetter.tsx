...
export default function NewsLetter() {
  return (
    <div className="relative md:py-20 py-3 w-full px-5 flex flex-col md:justify-center md:items-center ">
      <div className="flex relative flex-col bg-black rounded-xl border-green-400  border-2 max-w-[1024px] items-center px-8 py-20 md:px-20">
        <h1 className="text-xl md:text-4xl font-bold text-center md:text-left pb-6">Want to be aware of all update</h1>
